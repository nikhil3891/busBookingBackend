...
export interface IUser extends Document {
  _id: Types.ObjectId;
  id: string; // virtual provided by Mongoose
...
const userSchema = new Schema<IUser>({
  ...
  email: { type: String, unique: false, sparse: true, lowercase: true },
  ...
  createdBy: { type: String } // ID of admin who created this user
}, { timestamps: true });
